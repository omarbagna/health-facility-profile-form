...
hefraNumberYes.addEventListener("click", () => {
  console.log("hefraNumberYes.checked::".hefraNumberYes.checked);
...
hefraNumberNo.addEventListener("click", () => {
  console.log("hefraNumberNo.checked::".hefraNumberNo.checked);
...
function validateForm() {
  var agreement = document.getElementById("submission_agreement").checked;

  if (agreement) {
    alert("You must agree to the Information provided is accrate!");
    return false;
  }
